...
public:
    ...
    void detectTopPatches(MySVM &svm, const QStringList &target_depth_list, const QStringList &target_image_list,
                          ...
                          int m);
    void getHardExmaples(MySVM &svm, const QStringList &negative_images_list, std::vector<Mat> &hard_examples);
    void train();
    ...
    void svmTrain(const Mat &positive_descriptor_Mat, const Mat &negative_descriptor_Mat, MySVM &svm);
